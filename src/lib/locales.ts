...
export const en = {
    ...
    auth: {
        signUp: {
            ...
            emailHelp: 'Must end with @utas.edu.om or @student.utas.edu.om',
        ...
        signIn: {
            ...
            resetPassword: {
                ...
                emailLabel: 'University Email',
                emailPlaceholder: 'student@utas.edu.om',
    ...
    auth: {
        ...
        signIn: {
            ...
            resetPassword: {
                ...
                emailLabel: 'البريد الجامعي',
                emailPlaceholder: 'student@utas.edu.om',
                submitBtn: 'إرسال رابط التعيين',
                sending: 'جاري الإرسال...',
                success: 'تم الإرسال! تفقد بريدك الإلكتروني.',
                backToSignIn: 'العودة لتسجيل الدخول',
                errors: {
                    userNotFound: 'لا يوجد حساب بهذا البريد الإلكتروني.',
                    generic: 'فشل إرسال البريد. يرجى المحاولة مرة أخرى.',
                },
            },
        },
    },
